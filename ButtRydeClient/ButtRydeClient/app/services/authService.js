'use strict';
app.factory('authService', ['$http', '$q', 'ngAuthSettings', 'localStorageService', function ($http, $q, ngAuthSettings, localStorageService) {
    ...
    var _login = function (loginData) {
        ...
        */
        ...
        $http.post(serviceBase + oauthToken, data, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
            /*
            if (loginData.useRefreshTokens) {
