...
app.factory('companiesDataSource', ['$http', '$rootScope', 'ngAuthSettings', 'companyListViewModel', 'messageService', 'localStorageService',
    function ($http, $rootScope, ngAuthSettings, companyListViewModel, messageService, localStorageService) {

        var serviceBase = ngAuthSettings.apiServiceBaseUri + 'api/companies/';
