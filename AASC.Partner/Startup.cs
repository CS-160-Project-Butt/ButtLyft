...
namespace AASC.Partner.API
{
    public partial class Startup
    {
        ...
        private void ConfigAutofacIoC(HttpConfiguration httpConfig)
        {
            ...
            builder.RegisterType<PhaseOutDataService>().As<IPhaseOutDataService>().InstancePerLifetimeScope();
            builder.RegisterType<PhaseOutPrepBizService>().As<IPhaseOutPrepBizService>().InstancePerLifetimeScope();
