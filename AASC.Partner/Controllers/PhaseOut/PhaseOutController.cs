...
{       
    ...
    [RoutePrefix("api/phaseout")]
    public class PhaseOutController : BaseApiController
    {
        protected readonly IPhaseOutPrepBizService _phaseOutPrepService;

        public PhaseOutController(
            IPhaseOutPrepBizService phaseOutPrepService
            )
        {
            _phaseOutPrepService = phaseOutPrepService;
        }
        ...
        public IHttpActionResult Get()
        {
            try
            {
                ...
                var result = _phaseOutPrepService.Get(pageSize, page, skip, take, sorting, filter);
        ...
        //public async Task<IHttpActionResult> UpdateCLAForm(PhaseOutPrepViewModel model)
        //{
        //    if (!ModelState.IsValid)
        //        return BadRequest(ModelState);
            
        //    var result = _phaseOutPrepService.Update(model);
        ...
        //    var body = _phaseOutPrepService.GetEmailBody(id);
        ...
        //[HttpPost]
        //[System.Web.Mvc.ValidateAntiForgeryToken]
        //public async Task<IHttpActionResult> AddCLAForm(PhaseOutPrepViewModel model)
        //{

        //    if (!ModelState.IsValid)
        //        return BadRequest(ModelState);

        //    var result = _phaseOutPrepService.Create(model);
        ...
        ////        var result = _phaseOutPrepService.GetDisplayList();
