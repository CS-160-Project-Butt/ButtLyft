'use strict';
app.controller('PhaseOutExecutionCtrl', ['$q', '$rootScope', '$http', '$location', 'authService', 'ngAuthSettings', 'phaseOutService',
    'phaseOutPrepViewModel', 'phaseOutExecutionDataSource', 'dialogService', 'messageService', 'messageDataService',
    function ($q, $rootScope, $http, $location, authService, ngAuthSettings, phaseOutService,
        ...
        vm.dataSource = phaseOutExecutionDataSource;
