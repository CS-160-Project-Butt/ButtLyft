...
app.config(function ($routeProvider, $locationProvider) {
    ...
    */
    ...
    $routeProvider.when("/phaseout", {
        controller: "BeginCtrl as vm",
        templateUrl: "/app/views/phaseout/intro.html"
    });

    $routeProvider.when("/phaseout/prep", {
        controller: "PhaseOutPrepCtrl as vm",
        templateUrl: "/app/views/phaseout/prep.html"
    });

    $routeProvider.when("/phaseout/execution", {
        controller: "PhaseOutExecutionCtrl as vm",
        templateUrl: "/app/views/phaseout/execute.html"
    });

    $routeProvider.when("/phaseout/view/:id", {
        controller: "ProductCustomerRelationCtrl as vm",
        templateUrl: "/app/views/phaseout/productview.html"
    }); 


    $routeProvider.otherwise({ redirectTo: "/phaseout" });
