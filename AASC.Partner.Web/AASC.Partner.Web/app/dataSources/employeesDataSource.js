...
app.factory('employeesDataSource', ['$http', '$rootScope', 'ngAuthSettings', 'employeeListViewModel', 'messageService', 'localStorageService',
    function ($http, $rootScope, ngAuthSettings, employeeListViewModel, messageService, localStorageService) {

        var serviceBase = ngAuthSettings.apiServiceBaseUri + 'api/employees/';
